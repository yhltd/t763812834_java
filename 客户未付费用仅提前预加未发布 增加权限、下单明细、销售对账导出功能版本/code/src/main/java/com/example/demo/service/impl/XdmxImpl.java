...
public class XdmxImpl extends ServiceImpl<XdmxMapper, Xdmx> implements XdmxService {
    ...
    @Override
    public List<Xdmx> exportScgd(ScgdSearchRequest request) {
        LambdaQueryWrapper<Xdmx> wrapper = buildQueryWrapper(request);
        return baseMapper.selectList(wrapper);
    }

    @Override
    public List<Xdmx> exportScgdYW(ScgdSearchRequest request, String fuzeren) {
        LambdaQueryWrapper<Xdmx> wrapper = buildQueryWrapper(request);
        return baseMapper.selectForPageYW(1, 1000000L, wrapper, fuzeren);
    }
